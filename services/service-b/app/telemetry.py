"""Instrumentacion manual de service-b (T1.4, T1.5, T1.6).
...
tracer = trace.get_tracer("otel-lab.inventory", INSTRUMENTATION_VERSION)
meter = metrics.get_meter("otel-lab.inventory", INSTRUMENTATION_VERSION)
